...
return cljs.core.boolean$((function (){var or__4047__auto__ = cljs.core.some(cljs.core.some_fn.cljs$core$IFn$_invoke$arity$3(cljs.core.nil_QMARK_,meta_merge.core.displace_QMARK_,meta_merge.core.replace_QMARK_),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [left,right], null));
...
if(cljs.core.truth_((function (){var and__4036__auto__ = meta_merge.core.displace_QMARK_(left);
...
if(cljs.core.truth_((function (){var and__4036__auto__ = meta_merge.core.replace_QMARK_(left);
if(cljs.core.truth_(and__4036__auto__)){
...
if(cljs.core.truth_((function (){var or__4047__auto__ = meta_merge.core.displace_QMARK_(left);
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
return meta_merge.core.replace_QMARK_(right);
...
if(cljs.core.truth_((function (){var or__4047__auto__ = meta_merge.core.replace_QMARK_(left);
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
return meta_merge.core.displace_QMARK_(right);
...
var len__4641__auto___26449 = arguments.length;
var i__4642__auto___26450 = (0);
while(true){
if((i__4642__auto___26450 < len__4641__auto___26449)){
args_arr__4662__auto__.push((arguments[i__4642__auto___26450]));

var G__26451 = (i__4642__auto___26450 + (1));
i__4642__auto___26450 = G__26451;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var or__4047__auto__ = cljs.core.cst$kw$prepend.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(left));
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
/** @this {Function} */
meta_merge.core.meta_merge.cljs$lang$applyTo = (function (seq26444){
...
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26445,G__26446,seq26444__$2);
});
