...
if((i < len)){
var k = (ks[i]);
var G__32476 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__32477 = (i + (1));
m = G__32476;
i = G__32477;
continue;
...
var temp__5722__auto__ = (p["argv"]);
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__32478 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__32478) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__32478));
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__32480 = c;
var G__32480__$1 = (((G__32480 == null))?null:G__32480.prototype);
if((G__32480__$1 == null)){
return null;
} else {
return (G__32480__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__32482 = c;
var G__32482__$1 = (((G__32482 == null))?null:G__32482.prototype);
if((G__32482__$1 == null)){
return null;
} else {
return (G__32482__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__32486__delegate = function (args){
var G__32484 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__32484) : reagent.impl.component.as_element.call(null,G__32484));
};
...
while (G__32487__i < G__32487__a.length) {G__32487__a[G__32487__i] = arguments[G__32487__i + 0]; ++G__32487__i;}
  args = new cljs.core.IndexedSeq(G__32487__a,0,null);
} 
return G__32486__delegate.call(this,args);};
...
return G__32486__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__32490 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__32491 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__32491;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__32490;
}});
...
var G__32492 = key;
var G__32492__$1 = (((G__32492 instanceof cljs.core.Keyword))?G__32492.fqn:null);
switch (G__32492__$1) {
...
return ((function (G__32492,G__32492__$1){
...
var c = this;
var G__32497_32499 = (c["cljsRatom"]);
if((G__32497_32499 == null)){
} else {
reagent.ratom.dispose_BANG_(G__32497_32499);
}
...
var renders_32501 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_32502 = cljs.core.first(cljs.core.vals(renders_32501));
if((cljs.core.count(renders_32501) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_32501))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_32502)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_32502], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__32500 = name;
switch (G__32500) {
case "":
...
var G__32505 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__32505) : reagent.impl.component.global$module$create_react_class.call(null,G__32505));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__32506 = fiber;
var G__32506__$1 = (((G__32506 == null))?null:(G__32506["type"]));
if((G__32506__$1 == null)){
return null;
} else {
return (G__32506__$1["displayName"]);
}
})();
var parent = (function (){var G__32507 = fiber;
if((G__32507 == null)){
return null;
} else {
return (G__32507["return"]);
}
})();
var path = (function (){var G__32508 = parent;
var G__32508__$1 = (((G__32508 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__32508) : reagent.impl.component.fiber_component_path.call(null,G__32508)));
if((G__32508__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__32508__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4047__auto__ = (function (){var G__32510 = c;
if((G__32510 == null)){
return null;
} else {
return (G__32510["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
...
return G__32511._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4047__auto__ = (function (){var G__32513 = c;
if((G__32513 == null)){
return null;
} else {
return (G__32513["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
var or__4047__auto____$1 = (function (){var G__32515 = c;
if((G__32515 == null)){
return null;
} else {
return G__32515._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4047__auto__ = (function (){var G__32517 = instance;
if((G__32517 == null)){
return null;
} else {
return (G__32517["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
var G__32518 = instance;
if((G__32518 == null)){
return null;
} else {
return G__32518._currentElement;
}
}
})();
var name = (function (){var G__32519 = elem;
var G__32519__$1 = (((G__32519 == null))?null:(G__32519["type"]));
if((G__32519__$1 == null)){
return null;
} else {
return (G__32519__$1["displayName"]);
}
})();
var owner = (function (){var or__4047__auto__ = (function (){var G__32521 = elem;
if((G__32521 == null)){
return null;
} else {
return (G__32521["_owner"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
...
return G__32522._owner;
}
}
})();
var path = (function (){var G__32523 = owner;
var G__32523__$1 = (((G__32523 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__32523) : reagent.impl.component.component_path.call(null,G__32523)));
if((G__32523__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__32523__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__32524 = c;
var G__32524__$1 = (((G__32524 == null))?null:G__32524.constructor);
if((G__32524__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__32524__$1);
}
}
})();
