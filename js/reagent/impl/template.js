...
var G__29976 = o;
(G__29976[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__29978__i < G__29978__a.length) {G__29978__a[G__29978__i] = arguments[G__29978__i + 0]; ++G__29978__i;}
  args = new cljs.core.IndexedSeq(G__29978__a,0,null);
} 
...
var G__29980 = o;
(G__29980[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__29985 = props;
var G__29985__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29985,cljs.core.cst$kw$id,id):G__29985);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29985__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__29986){
...
var props = map__29987__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29987__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__29987,map__29987__$1,props,class$){
return (function (c){
...
});})(map__29987,map__29987__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__29989){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29990__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__29990,map__29990__$1,on_write){
return (function (){
...
});})(node_value,map__29990,map__29990__$1,on_write))
);
} else {
...
return reagent.impl.template.input_handle_change(this$,on_change,p1__29992_SHARP_);
...
var vec__29996 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29996,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29996,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29996,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___30000 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___30000 == null)){
} else {
var key_30001 = temp__5724__auto___30000;
(jsprops["key"] = key_30001);
}
...
var temp__5724__auto___30002 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___30002 == null)){
} else {
var key_30003 = temp__5724__auto___30002;
reagent.impl.template.oset(jsprops,"key",key_30003);
}
...
var G__30004 = reagent.impl.template.__GT_NativeWrapper();
(G__30004["name"] = c);
...
var G__30005 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__30005) : reagent.impl.template.as_element.call(null,G__30005));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq30008){
var G__30009 = cljs.core.first(seq30008);
var seq30008__$1 = cljs.core.next(seq30008);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30009,seq30008__$1);
});
...
break;
default:
var G__30015 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__30015;
continue;
...
var n__4518__auto___30017 = a.length;
var i_30018 = (0);
while(true){
if((i_30018 < n__4518__auto___30017)){
(a[i_30018] = reagent.impl.template.as_element((a[i_30018])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4518__auto___30020 = a.length;
var i_30021 = (0);
while(true){
if((i_30021 < n__4518__auto___30020)){
var val_30022 = (a[i_30021]);
if(((cljs.core.vector_QMARK_(val_30022)) && ((reagent.impl.template.key_from_vec(val_30022) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_30021] = reagent.impl.template.as_element(val_30022));
...
var ctx = ({});
var vec__30024 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30024,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30024,(1),null);
...
var G__30027 = (cljs.core.count(argv) - first_child);
switch (G__30027) {
case (0):
...
case (1):
var G__30028 = comp;
var G__30029 = jsprops;
var G__30030 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__30028,G__30029,G__30030) : reagent.impl.template.global$module$react.createElement.call(null,G__30028,G__30029,G__30030));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__30027){
