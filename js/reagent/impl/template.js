...
var G__32615 = o;
(G__32615[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__32616__delegate = function (args){
...
while (G__32617__i < G__32617__a.length) {G__32617__a[G__32617__i] = arguments[G__32617__i + 0]; ++G__32617__i;}
  args = new cljs.core.IndexedSeq(G__32617__a,0,null);
} 
return G__32616__delegate.call(this,args);};
G__32616.cljs$lang$maxFixedArity = 0;
G__32616.cljs$lang$applyTo = (function (arglist__32618){
var args = cljs.core.seq(arglist__32618);
return G__32616__delegate(args);
});
...
var G__32619 = o;
(G__32619[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__32624 = props;
var G__32624__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32624,cljs.core.cst$kw$id,id):G__32624);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32624__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__32625){
var map__32626 = p__32625;
var map__32626__$1 = (((((!((map__32626 == null))))?(((((map__32626.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__32626.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__32626):map__32626);
var props = map__32626__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32626__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__32626,map__32626__$1,props,class$){
return (function (c){
...
});})(map__32626,map__32626__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__32628){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32629__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__32629,map__32629__$1,on_write){
return (function (){
...
});})(node_value,map__32629,map__32629__$1,on_write))
);
} else {
...
var G__32632 = jsprops;
(G__32632["defaultValue"] = value);

(G__32632["onChange"] = ((function (G__32632,v,value,on_change){
return (function (p1__32631_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__32631_SHARP_);
});})(G__32632,v,value,on_change))
);
...
var vec__32635 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32635,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32635,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32635,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___32639 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___32639 == null)){
} else {
var key_32640 = temp__5724__auto___32639;
(jsprops["key"] = key_32640);
}
...
var temp__5724__auto___32641 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___32641 == null)){
} else {
var key_32642 = temp__5724__auto___32641;
reagent.impl.template.oset(jsprops,"key",key_32642);
}
...
var G__32643 = reagent.impl.template.__GT_NativeWrapper();
(G__32643["name"] = c);
...
var G__32644 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__32644) : reagent.impl.template.as_element.call(null,G__32644));
} else {
...
var len__4641__auto___32649 = arguments.length;
var i__4642__auto___32650 = (0);
while(true){
if((i__4642__auto___32650 < len__4641__auto___32649)){
args__4647__auto__.push((arguments[i__4642__auto___32650]));

var G__32651 = (i__4642__auto___32650 + (1));
i__4642__auto___32650 = G__32651;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq32647){
var G__32648 = cljs.core.first(seq32647);
var seq32647__$1 = cljs.core.next(seq32647);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32648,seq32647__$1);
});
...
var n__4518__auto___32656 = a.length;
var i_32657 = (0);
while(true){
if((i_32657 < n__4518__auto___32656)){
(a[i_32657] = reagent.impl.template.as_element((a[i_32657])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4518__auto___32659 = a.length;
var i_32660 = (0);
while(true){
if((i_32660 < n__4518__auto___32659)){
var val_32661 = (a[i_32660]);
if(((cljs.core.vector_QMARK_(val_32661)) && ((reagent.impl.template.key_from_vec(val_32661) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_32660] = reagent.impl.template.as_element(val_32661));

var G__32662 = (i_32660 + (1));
i_32660 = G__32662;
continue;
} else {
}
...
var ctx = ({});
var vec__32663 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32663,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32663,(1),null);
...
var G__32666 = (cljs.core.count(argv) - first_child);
switch (G__32666) {
case (0):
...
case (1):
var G__32667 = comp;
var G__32668 = jsprops;
var G__32669 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__32667,G__32668,G__32669) : reagent.impl.template.global$module$react.createElement.call(null,G__32667,G__32668,G__32669));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__32666){
