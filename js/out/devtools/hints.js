...
}catch (e39307){var _e = e39307;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___39310 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___39310)){
var seen_errors_39311 = temp__5718__auto___39310;
if(cljs.core.truth_(seen_errors_39311.has(self))){
} else {
seen_errors_39311.add(self);

var temp__5720__auto___39312 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___39312)){
var sense_39313 = temp__5720__auto___39312;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_39313)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1552827703433
