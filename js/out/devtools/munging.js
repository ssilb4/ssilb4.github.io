...
var o28265 = temp__5718__auto__;
var temp__5718__auto____$1 = (o28265["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o28266 = temp__5718__auto____$1;
return (o28266["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27375__auto__ = f;
return (o__27375__auto__["toString"]).call(o__27375__auto__);
} else {
return "";
}
...
try{var o__27375__auto___28269 = t;
(o__27375__auto___28269["cljs$lang$ctorPrWriter"]).call(o__27375__auto___28269,t,writer);
}catch (e28268){var __28270 = e28268;
}
...
var char_code = (function (){var o__27375__auto__ = (new String(char$));
return (o__27375__auto__["charCodeAt"]).call(o__27375__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27375__auto__ = String;
return (o__27375__auto__["fromCharCode"]).call(o__27375__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28271 = num_code;
switch (G__28271) {
case (1):
return (185);
...
var o__27375__auto__ = String;
return (o__27375__auto__["fromCharCode"]).call(o__27375__auto__,superscript_code);
});
/**
...
}catch (e28273){var _e__27382__auto__ = e28273;
return false;
}})())){
...
var vec__28274 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__28274,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o28277 = temp__5718__auto__;
var temp__5718__auto____$1 = (o28277["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o28278 = temp__5718__auto____$1;
return (o28278["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4641__auto___28285 = arguments.length;
var i__4642__auto___28286 = (0);
while(true){
if((i__4642__auto___28286 < len__4641__auto___28285)){
args__4647__auto__.push((arguments[i__4642__auto___28286]));

var G__28287 = (i__4642__auto___28286 + (1));
i__4642__auto___28286 = G__28287;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28281){
var vec__28282 = p__28281;
var ns_detector = cljs.core.nth.call(null,vec__28282,(0),null);
...
var G__28288 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__28289 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__28288;
remaining_tokens = G__28289;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28279){
var G__28280 = cljs.core.first.call(null,seq28279);
var seq28279__$1 = cljs.core.next.call(null,seq28279);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28280,seq28279__$1);
});
...
var vec__28293 = cljs.core.split_with.call(null,(function (p1__28292_SHARP_){
return cljs.core.not_EQ_.call(null,p1__28292_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__28293,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__28293,(1),null);
...
var vec__28296 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__28296,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__28296,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__28299 = cljs.core.rest.call(null,remaining_tokens);
var G__28300 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__28299;
name_tokens = G__28300;
continue;
} else {
...
var vec__28303 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__28303,(0),null);
var arity = cljs.core.nth.call(null,vec__28303,(1),null);
var vec__28306 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__28306,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__28306,(1),null);
var vec__28309 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__28309,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__28309,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__28309,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__28309,(3),null);
...
var vec__28315 = result;
var munged_ns = cljs.core.nth.call(null,vec__28315,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__28315,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__28315,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__28315,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__28315,(4),null);
var arity = cljs.core.nth.call(null,vec__28315,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__28319 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__28319,(0),null);
var args = cljs.core.nth.call(null,vec__28319,(1),null);
var vec__28322 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__28322,(0),null);
var name = cljs.core.nth.call(null,vec__28322,(1),null);
...
var G__28325 = (arity + (1));
var G__28326 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28327){
var vec__28328 = p__28327;
var arity = cljs.core.nth.call(null,vec__28328,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__28328,(1),null);
...
return cljs.core.get.call(null,arities,p1__28331_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__28332_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28335){
var vec__28336 = p__28335;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__28336,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28333){
var G__28334 = cljs.core.first.call(null,seq28333);
var seq28333__$1 = cljs.core.next.call(null,seq28333);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28334,seq28333__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__28344__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__28344__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__28344__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__28344__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28345 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__28345,(0),null);
var fn_name = cljs.core.nth.call(null,vec__28345,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__28345,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__28345,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__28345,(4),null);
var arity = cljs.core.nth.call(null,vec__28345,(5),null);
...
var o__27375__auto__ = f;
return (o__27375__auto__["getBasis"]).call(o__27375__auto__);
});
/**
...
}catch (e28349){var _e__27382__auto__ = e28349;
...
var G__28350 = (obj[cljs.core.first.call(null,path)]);
var G__28351 = cljs.core.rest.call(null,path);
obj = G__28350;
path = G__28351;
continue;
} else {
...
return (function (accum,p__28352){
var vec__28353 = p__28352;
var bit = cljs.core.nth.call(null,vec__28353,(0),null);
var protocol = cljs.core.nth.call(null,vec__28353,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28356){
var vec__28357 = p__28356;
var ns = cljs.core.nth.call(null,vec__28357,(0),null);
var name = cljs.core.nth.call(null,vec__28357,(1),null);
var selector = cljs.core.nth.call(null,vec__28357,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__28362,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__28362,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__28362,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__28360_SHARP_){
return (obj[cljs.core.first.call(null,p1__28360_SHARP_)]);
});})(name,sorted_matches,vec__28362,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1552709041141
