...
var o28943 = temp__5718__auto__;
var temp__5718__auto____$1 = (o28943["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o28944 = temp__5718__auto____$1;
return (o28944["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27873__auto__ = f;
return (o__27873__auto__["toString"]).call(o__27873__auto__);
} else {
return "";
}
}catch (e28945){var _ = e28945;
return "";
}});
...
try{var o__27873__auto___28947 = t;
(o__27873__auto___28947["cljs$lang$ctorPrWriter"]).call(o__27873__auto___28947,t,writer);
}catch (e28946){var __28948 = e28946;
}
...
var char_code = (function (){var o__27873__auto__ = (new String(char$));
return (o__27873__auto__["charCodeAt"]).call(o__27873__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27873__auto__ = String;
return (o__27873__auto__["fromCharCode"]).call(o__27873__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28949 = num_code;
switch (G__28949) {
case (1):
return (185);
...
var o__27873__auto__ = String;
return (o__27873__auto__["fromCharCode"]).call(o__27873__auto__,superscript_code);
});
/**
...
}catch (e28951){var _e__27880__auto__ = e28951;
return false;
}})())){
...
var vec__28952 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__28952,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o28955 = temp__5718__auto__;
var temp__5718__auto____$1 = (o28955["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o28956 = temp__5718__auto____$1;
return (o28956["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4641__auto___28963 = arguments.length;
var i__4642__auto___28964 = (0);
while(true){
if((i__4642__auto___28964 < len__4641__auto___28963)){
args__4647__auto__.push((arguments[i__4642__auto___28964]));

var G__28965 = (i__4642__auto___28964 + (1));
i__4642__auto___28964 = G__28965;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28959){
var vec__28960 = p__28959;
var ns_detector = cljs.core.nth.call(null,vec__28960,(0),null);
...
var G__28966 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__28967 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__28966;
remaining_tokens = G__28967;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28957){
var G__28958 = cljs.core.first.call(null,seq28957);
var seq28957__$1 = cljs.core.next.call(null,seq28957);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28958,seq28957__$1);
});
...
var vec__28971 = cljs.core.split_with.call(null,(function (p1__28970_SHARP_){
return cljs.core.not_EQ_.call(null,p1__28970_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__28971,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__28971,(1),null);
...
var vec__28974 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__28974,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__28974,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__28977 = cljs.core.rest.call(null,remaining_tokens);
var G__28978 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__28977;
...
var vec__28981 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__28981,(0),null);
var arity = cljs.core.nth.call(null,vec__28981,(1),null);
var vec__28984 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__28984,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__28984,(1),null);
var vec__28987 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__28987,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__28987,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__28987,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__28987,(3),null);
...
var vec__28993 = result;
var munged_ns = cljs.core.nth.call(null,vec__28993,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__28993,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__28993,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__28993,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__28993,(4),null);
var arity = cljs.core.nth.call(null,vec__28993,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__28997 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__28997,(0),null);
var args = cljs.core.nth.call(null,vec__28997,(1),null);
var vec__29000 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__29000,(0),null);
var name = cljs.core.nth.call(null,vec__29000,(1),null);
...
var G__29003 = (arity + (1));
var G__29004 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__29005){
var vec__29006 = p__29005;
var arity = cljs.core.nth.call(null,vec__29006,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__29006,(1),null);
...
return cljs.core.get.call(null,arities,p1__29009_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__29010_SHARP_);
...
var args__4647__auto__ = [];
var len__4641__auto___29017 = arguments.length;
var i__4642__auto___29018 = (0);
while(true){
if((i__4642__auto___29018 < len__4641__auto___29017)){
args__4647__auto__.push((arguments[i__4642__auto___29018]));

var G__29019 = (i__4642__auto___29018 + (1));
i__4642__auto___29018 = G__29019;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__29013){
var vec__29014 = p__29013;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__29014,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq29011){
var G__29012 = cljs.core.first.call(null,seq29011);
var seq29011__$1 = cljs.core.next.call(null,seq29011);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29012,seq29011__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__29022__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__29022__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__29022__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__29022__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__29023 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__29023,(0),null);
var fn_name = cljs.core.nth.call(null,vec__29023,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__29023,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__29023,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__29023,(4),null);
var arity = cljs.core.nth.call(null,vec__29023,(5),null);
...
var o__27873__auto__ = f;
return (o__27873__auto__["getBasis"]).call(o__27873__auto__);
});
/**
...
}catch (e29027){var _e__27880__auto__ = e29027;
...
var G__29028 = (obj[cljs.core.first.call(null,path)]);
var G__29029 = cljs.core.rest.call(null,path);
obj = G__29028;
path = G__29029;
continue;
} else {
...
return (function (accum,p__29030){
var vec__29031 = p__29030;
var bit = cljs.core.nth.call(null,vec__29031,(0),null);
var protocol = cljs.core.nth.call(null,vec__29031,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__29034){
var vec__29035 = p__29034;
var ns = cljs.core.nth.call(null,vec__29035,(0),null);
var name = cljs.core.nth.call(null,vec__29035,(1),null);
var selector = cljs.core.nth.call(null,vec__29035,(2),null);
...
return (function (p__29039){
var vec__29040 = p__29039;
var munged_name = cljs.core.nth.call(null,vec__29040,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__29040,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__29040,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__29038_SHARP_){
return (obj[cljs.core.first.call(null,p1__29038_SHARP_)]);
});})(name,sorted_matches,vec__29040,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1552827693998
