...
var G__34521 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__34521;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__34522 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__34522,ch);
...
if(("\\" === ch__$1)){
var ch_34523__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_34523__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_34523__$2);
} else {
}

var G__34524 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__34524;
continue;
}
}
...
var vec__34532 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__34532,(0),null);
var start_column = cljs.core.nth.call(null,vec__34532,(1),null);
...
var G__34535 = cljs.core.conj_BANG_.call(null,a,form);
a = G__34535;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__34536 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__34537 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__34537;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__34536;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__34538 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__34538,(0),null);
var start_column = cljs.core.nth.call(null,vec__34538,(1),null);
...
var vec__34541 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__34541,(0),null);
var end_column = cljs.core.nth.call(null,vec__34541,(1),null);
...
var vec__34547 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__34547,(0),null);
var end_column = cljs.core.nth.call(null,vec__34547,(1),null);
...
var sb = (function (){var G__34556 = (new goog.string.StringBuffer());
G__34556.append(initch);
...
var G__34558 = (function (){var G__34557 = sb;
G__34557.append(ch);

return G__34557;
})();
var G__34559 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__34558;
ch = G__34559;
continue;
}
...
switch (G__34562) {
case "\\":
var G__34566 = (function (){var G__34563 = sb;
G__34563.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__34563;
})();
var G__34567 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__34566;
ch = G__34567;
continue;
...
break;
default:
var G__34568 = (function (){var G__34564 = sb;
G__34564.append(ch);

return G__34564;
})();
var G__34569 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__34568;
ch = G__34569;
continue;
...
var vec__34570 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__34570,(0),null);
var end_column = cljs.core.nth.call(null,vec__34570,(1),null);
...
var vec__34583 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__34583,(0),null);
var column = cljs.core.nth.call(null,vec__34583,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__34588 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__34588,(0),null);
var start_column = cljs.core.nth.call(null,vec__34588,(1),null);
...
var vec__34591 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__34591,(0),null);
var end_column = cljs.core.nth.call(null,vec__34591,(1),null);
...
var G__34594 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__34594,true,null,opts,pending_forms);
...
var G__34595 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__34595)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__34595)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__34595)){
...
var _STAR_suppress_read_STAR__orig_val__34596 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__34597 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__34597;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__34596;
}});
...
var G__34598 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__34598,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__34598,rdr,first_line);
...
var G__34602 = matched;
var G__34603 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__34602;
finished = G__34603;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__34604 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__34605 = (function (){var or__4047__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__34605;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__34604;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__34606 = cljs.tools.reader.arg_env;
var arg_env_temp_val__34607 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__34607;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__34608 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__34608,"(");
...
var G__34609 = (i + (1));
var G__34610 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4047__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__34606;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__34611 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__34611);
...
var G__34612 = cljs.core.next.call(null,s__$1);
var G__34613 = ret;
s__$1 = G__34612;
r = G__34613;
continue;
...
var G__34614 = cljs.core.next.call(null,s);
var G__34615 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__34614;
key_vals = G__34615;
continue;
} else {
...
var gensym_env_orig_val__34619 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__34620 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__34620;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__34619;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__34621 = token;
var G__34621__$1 = (((G__34621 == null))?null:cljs.core.subs.call(null,G__34621,(1)));
var G__34621__$2 = (((G__34621__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__34621__$1));
var G__34621__$3 = (((G__34621__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__34621__$2));
var G__34621__$4 = (((G__34621__$3 == null))?null:cljs.core.symbol.call(null,G__34621__$3));
if((G__34621__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__34621__$4);
}
})():(function (){var G__34622 = token;
var G__34622__$1 = (((G__34622 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__34622));
if((G__34622__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__34622__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
}catch (e34629){if((e34629 instanceof Error)){
var e = e34629;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__34633,reader){
...
var opts = map__34634__$1;
var eof = cljs.core.get.call(null,map__34634__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4641__auto___34642 = arguments.length;
var i__4642__auto___34643 = (0);
while(true){
if((i__4642__auto___34643 < len__4641__auto___34642)){
args__4647__auto__.push((arguments[i__4642__auto___34643]));

var G__34644 = (i__4642__auto___34643 + (1));
i__4642__auto___34643 = G__34644;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq34640){
var G__34641 = cljs.core.first.call(null,seq34640);
var seq34640__$1 = cljs.core.next.call(null,seq34640);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34641,seq34640__$1);
});


//# sourceMappingURL=reader.js.map?rel=1552709047491
