...
return (new CustomEvent(event_name,(function (){var obj46580 = {"detail":data};
return obj46580;
})()));
} else {
...
var f = (function (){var pred__46587 = cljs.core._EQ_;
var expr__46588 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__46587.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__46588))){
return ((function (pred__46587,expr__46588){
return (function (p1__46581_SHARP_){
return console.warn(p1__46581_SHARP_);
});
;})(pred__46587,expr__46588))
} else {
if(cljs.core.truth_(pred__46587.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__46588))){
return ((function (pred__46587,expr__46588){
return (function (p1__46582_SHARP_){
return console.debug(p1__46582_SHARP_);
});
;})(pred__46587,expr__46588))
} else {
if(cljs.core.truth_(pred__46587.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__46588))){
return ((function (pred__46587,expr__46588){
return (function (p1__46583_SHARP_){
return console.error(p1__46583_SHARP_);
});
;})(pred__46587,expr__46588))
} else {
return ((function (pred__46587,expr__46588){
return (function (p1__46584_SHARP_){
return console.log(p1__46584_SHARP_);
});
;})(pred__46587,expr__46588))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__46591){
...
var opts = map__46592__$1;
var eval_fn = cljs.core.get.call(null,map__46592__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__46594_SHARP_);
});})(new_def))
);
...
return (function (p__46595){
var vec__46596 = p__46595;
var ky = cljs.core.nth.call(null,vec__46596,(0),null);
var v = cljs.core.nth.call(null,vec__46596,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1552827710714
