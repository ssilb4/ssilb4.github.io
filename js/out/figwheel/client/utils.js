...
return (new CustomEvent(event_name,(function (){var obj34845 = {"detail":data};
return obj34845;
})()));
} else {
...
var f = (function (){var pred__34852 = cljs.core._EQ_;
var expr__34853 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34852.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34853))){
return ((function (pred__34852,expr__34853){
return (function (p1__34846_SHARP_){
return console.warn(p1__34846_SHARP_);
});
;})(pred__34852,expr__34853))
} else {
if(cljs.core.truth_(pred__34852.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34853))){
return ((function (pred__34852,expr__34853){
return (function (p1__34847_SHARP_){
return console.debug(p1__34847_SHARP_);
});
;})(pred__34852,expr__34853))
} else {
if(cljs.core.truth_(pred__34852.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34853))){
return ((function (pred__34852,expr__34853){
return (function (p1__34848_SHARP_){
return console.error(p1__34848_SHARP_);
});
;})(pred__34852,expr__34853))
} else {
return ((function (pred__34852,expr__34853){
return (function (p1__34849_SHARP_){
return console.log(p1__34849_SHARP_);
});
;})(pred__34852,expr__34853))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34856){
...
var opts = map__34857__$1;
var eval_fn = cljs.core.get.call(null,map__34857__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34859_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__34861,(0),null);
...
}catch (e34866){if((e34866 instanceof Error)){
var e = e34866;
return not_found;
} else {
throw e34866;
...
//# sourceMappingURL=utils.js.map?rel=1552709048049
