...
var temp__5718__auto___33673 = event.state;
if(cljs.core.truth_(temp__5718__auto___33673)){
var state_33674 = temp__5718__auto___33673;
var temp__5720__auto___33675 = (state_33674["scroll-top"]);
if(cljs.core.truth_(temp__5720__auto___33675)){
var scroll_top_33676 = temp__5720__auto___33675;
goog.events.listenOnce(window,goog.events.EventType.SCROLL,((function (scroll_top_33676,temp__5720__auto___33675,state_33674,temp__5718__auto___33673){
return (function (){
scrollTo((0),scroll_top_33676);

return null;
});})(scroll_top_33676,temp__5720__auto___33675,state_33674,temp__5718__auto___33673))
);
} else {
}
} else {
...
var scroll_top_33677 = clerk.core.get_scroll_top.call(null);
var state_33678 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"scroll-top","scroll-top",-46723100),scroll_top_33677], null);
history.replaceState(cljs.core.clj__GT_js.call(null,state_33678),document.title);
...
var len__4641__auto___33685 = arguments.length;
var i__4642__auto___33686 = (0);
while(true){
if((i__4642__auto___33686 < len__4641__auto___33685)){
args__4647__auto__.push((arguments[i__4642__auto___33686]));

var G__33687 = (i__4642__auto___33686 + (1));
i__4642__auto___33686 = G__33687;
continue;
} else {
}
break;
...
clerk.core.navigate_page_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__33681){
var vec__33682 = p__33681;
var top_element_id = cljs.core.nth.call(null,vec__33682,(0),null);
...
return clerk.core.defer_page_navigation_BANG_.call(null,((function (y,temp__5718__auto__,uri,path,old_path,same_page_QMARK_,fragment,vec__33682,top_element_id){
return (function (){
return clerk.core.scroll_to.call(null,y);
});})(y,temp__5718__auto__,uri,path,old_path,same_page_QMARK_,fragment,vec__33682,top_element_id))
);
}
} else {
...
return clerk.core.defer_page_navigation_BANG_.call(null,((function (y_translation,temp__5718__auto__,uri,path,old_path,same_page_QMARK_,fragment,vec__33682,top_element_id){
return (function (){
...
});})(y_translation,temp__5718__auto__,uri,path,old_path,same_page_QMARK_,fragment,vec__33682,top_element_id))
);
}
}
});
...
/** @this {Function} */
clerk.core.navigate_page_BANG_.cljs$lang$applyTo = (function (seq33679){
var G__33680 = cljs.core.first.call(null,seq33679);
var seq33679__$1 = cljs.core.next.call(null,seq33679);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33680,seq33679__$1);
});
...
//# sourceMappingURL=core.js.map?rel=1552709045648
